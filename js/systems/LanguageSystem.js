    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                // Free Play Mode
                'FREE PLAY': 'FREE PLAY',
                'FREE PLAY MODES': 'FREE PLAY MODES',
                'FAMILY': 'FAMILY',
                'MISSIONS': 'MISSIONS',
                'UPGRADES': 'UPGRADES',
                'SPACE HUB': 'SPACE HUB',
                'CAMPAIGN MISSIONS': 'CAMPAIGN MISSIONS',
                'Replay completed missions or continue campaign': 'Replay completed missions or continue campaign',
                'MISSION REPLAY': 'MISSION REPLAY',
                'Replay any completed mission with your current upgrades': 'Replay any completed mission with your current upgrades',
                'SURVIVAL MODE': 'SURVIVAL MODE',
                'Endless waves with increasing difficulty. How long can you survive?': 'Endless waves with increasing difficulty. How long can you survive?',
                'High Score:': 'High Score:',
                'START SURVIVAL': 'START SURVIVAL',
                'MASTER MODE': 'MASTER MODE',
                'Unlimited special weapons! Only for true masters!': 'Unlimited special weapons! Only for true masters!',
                'ACTIVATE MASTER MODE': 'ACTIVATE MASTER MODE',
                'MASTER MODE ACTIVE': 'MASTER MODE ACTIVE',
                'Master Mode Activated! Unlimited special weapons!': 'Master Mode Activated! Unlimited special weapons!',
                'Master Mode Deactivated': 'Master Mode Deactivated',
                'BACK': 'BACK',
                'Wave': 'Wave',
                'SURVIVAL MODE COMPLETE': 'SURVIVAL MODE COMPLETE',
                'NEW HIGH SCORE!': 'NEW HIGH SCORE!',
                'Waves Survived:': 'Waves Survived:',
                'Survival Time:': 'Survival Time:',
                'PLAY AGAIN': 'PLAY AGAIN',
                'MISSION COMPLETE': 'MISSION COMPLETE',
                'Level Replayed:': 'Level Replayed:',
            ...
            ru: {
                ...
                'FREE PLAY MODES': 'РЕЖИМЫ СВОБОДНОЙ ИГРЫ',
                'FAMILY': 'СЕМЬЯ',
                'MISSIONS': 'МИССИИ',
                'UPGRADES': 'УЛУЧШЕНИЯ',
                'SPACE HUB': 'КОСМИЧЕСКАЯ БАЗА',
                'CAMPAIGN MISSIONS': 'МИССИИ КАМПАНИИ',
                'Replay completed missions or continue campaign': 'Переиграйте завершенные миссии или продолжите кампанию',
                'MISSION REPLAY': 'ПЕРЕИГРАТЬ МИССИЮ',
                'Replay any completed mission with your current upgrades': 'Переиграйте любую завершенную миссию с текущими улучшениями',
                'SURVIVAL MODE': 'РЕЖИМ ВЫЖИВАНИЯ',
                'Endless waves with increasing difficulty. How long can you survive?': 'Бесконечные волны с растущей сложностью. Как долго вы продержитесь?',
                'High Score:': 'Рекорд:',
                'START SURVIVAL': 'НАЧАТЬ ВЫЖИВАНИЕ',
                'MASTER MODE': 'РЕЖИМ МАСТЕРА',
                'Unlimited special weapons! Only for true masters!': 'Неограниченное спецоружие! Только для истинных мастеров!',
                'ACTIVATE MASTER MODE': 'АКТИВИРОВАТЬ РЕЖИМ МАСТЕРА',
                'MASTER MODE ACTIVE': 'РЕЖИМ МАСТЕРА АКТИВЕН',
                'Master Mode Activated! Unlimited special weapons!': 'Режим мастера активирован! Неограниченное спецоружие!',
                'Master Mode Deactivated': 'Режим мастера деактивирован',
                'BACK': 'НАЗАД',
                'Wave': 'Волна',
                'SURVIVAL MODE COMPLETE': 'РЕЖИМ ВЫЖИВАНИЯ ЗАВЕРШЁН',
                'NEW HIGH SCORE!': 'НОВЫЙ РЕКОРД!',
                'Waves Survived:': 'Пройдено волн:',
                'Survival Time:': 'Время выживания:',
                'PLAY AGAIN': 'ИГРАТЬ СНОВА',
                'MISSION COMPLETE': 'МИССИЯ ЗАВЕРШЕНА',
                'Level Replayed:': 'Уровень переигран:',
                'PLAY ANOTHER': 'ИГРАТЬ ДРУГОЙ',
